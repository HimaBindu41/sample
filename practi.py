...
conn = psycopg2.connect(
   database="bindu", user='postgres', password='root', host='127.0.0.1', port= '5432'
)
...
url = "https://api.github.com/search/repositories?sort=stars&order=desc&q=created%3A%3E2022-11-01&per_page=10&page=1" 
